(() => {
  ...
  function bookingRow(item) {
    ...
    const deal=item._deal||{},image=dealImage(deal),title=deal.title||item.deal_title||`Deal #${item.deal_id||"—"}`;
